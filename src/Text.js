var Text_render = function() {
  ...
  switch (Game_state) {
    ...
    case GAME_INSTRUCTIONS:
      Text_renderLine('[WASD] - move around', 80, -180);
      Text_renderLine('[Space] - jump and double jump', 80, -60);
      Text_renderLine('Mouse - Blaster Bow', 80, 60);
      Text_renderLine('You can\'t shoot in evil zones', 80, 180);
      break;
    case GAME_DIED:
      ...
      break;
    case GAME_WON:
      Text_renderLine('Zurbo, your darkness fades', 80, -180);
      Text_renderLine('Your world has been saved', 80, -60);
